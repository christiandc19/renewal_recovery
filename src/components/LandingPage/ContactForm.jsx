    ...
    return (
        <div className="contactForm">
            ...
            <div className="contactFormHeader contact2-container ">
                ...
                <p>If you or someone you love is struggling with both mental health and substance use disorders, don’t wait. Contact Renewal Recovery Center to learn more about our dual diagnosis treatment program and take the first step towards a healthier, addiction-free life.</p>
            ...
            <section className="container">
                    ...
                    <div className="footer_get_touch_inner">
                        <div className="get_form_inner">
                            ...
                            <div className="disclaimer">
                              <p>Renewal Recovery needs the contact information you provide to us to contact you about our products and services. You may unsubscribe from these communications at any time. For information on how to unsubscribe, as well as our privacy practices and commitment to protecting your privacy, please review our  
                ...
                <div className="get_form_inner2">
                    <h2>EMAIL</h2>
                    <p><AiOutlineMail /> info@RenewalRecovery.com </p><br />
                </div>

                <div className="get_form_inner2 no-border">
                    <h2>LOCATION</h2>
                    <p><BsFillPinMapFill /> 3720 Sunset Ln., Suite B, Renewal CA 94509</p>
                </div>
            </div>
