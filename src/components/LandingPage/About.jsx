...
const About = () => {
  ...
  return (
    ...
    <Fade bottom duration={2000}>
      ...
      <div className="aboutHomeImage" style={{ transform: `translate(${x}px, ${y}px)` }}>
          <img src={Logo} alt="logo" loading="lazy" />
        </div>
        
        <p>
        At Renewal Recovery, we believe in the power of healing, transformation, and support. Established with the vision of providing comprehensive care for individuals battling addiction and mental health challenges, we offer a safe haven where recovery is not only possible but sustainable. Our team of compassionate professionals is dedicated to creating personalized treatment plans tailored to meet the unique needs of each individual.
        </p>
        <p>
        We recognize that addiction is a multifaceted issue that affects every aspect of life, and that’s why our approach integrates medical, psychological, and holistic therapies. At Renewal Recovery, we aim to not only address the immediate challenges of substance abuse but also foster long-term well-being and personal growth.
        </p>
        ...
        <p>At Renewal Recovery, you are never alone. We walk alongside you through the toughest battles, empowering you to reclaim your life, rediscover hope, and embrace Renewal.
</p>
