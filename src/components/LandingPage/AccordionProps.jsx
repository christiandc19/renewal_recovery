...
function AccordionProps() {
  const accordionItems = [
    ...
    },
    {
      ...
      content: 'Renewal Recovery employs evidence-based treatment methods such as Cognitive Behavioral Therapy (CBT), Dialectical Behavior Therapy (DBT), and Medication-Assisted Treatment (MAT). These approaches have been scientifically proven to aid in both addiction recovery and mental health management.'
    }
  ];
  ...
  return (
    ...
    <div className='accordionFlex container'>
      <div className="accordionProps">
        <h1>Explore Our Comprehensive Addiction Rehab <br/> and Mental Health Services</h1>
        <Accordion items={accordionItems} />
      </div>

      <div className='accordionRight'>
        <img src={medicalProfessional} alt='Therapist' loading='lazy'/>
      </div>
    </div>
    </>
  );
